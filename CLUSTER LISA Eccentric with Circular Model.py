...
outdir = "LISAEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16"
...
plt.grid(True)
plt.tight_layout()
plt.savefig("LISAEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16/time_domain_signal.png")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("LISAEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16/pure_frequency_domain_signal.png")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("LISAEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16/frequency_domain_signal.png")
...
plt.tight_layout()
plt.savefig("LISAEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16/snr_plot.png")
...
plt.grid(True, which='minor', linestyle=':', linewidth=0.5, alpha=0.4)
plt.tight_layout()
plt.savefig("LISAEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16/snr_plot_data.png")
...
priors["e1"] = Uniform(0.05, 1, name="e1", latex_label=r"$e_1$")
...
if __name__ == "__main__":
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("LISAEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16/frequency_domain_signal_mle.png")
...
# ============================================================
    ...
    ax.grid(True)
    plt.tight_layout()
    plt.savefig("LISAEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16/posterior_draws_harmonics.png", dpi=150)