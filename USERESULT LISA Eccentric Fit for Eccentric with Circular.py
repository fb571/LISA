...
outdir = "LISAEccentricFitSingleCircModel,nlive=2000,SNRcirc=20(TBU)"
...
plt.grid(True)
plt.tight_layout()
plt.savefig("LISAEccentricFitSingleCircModel,nlive=2000,SNRcirc=20(TBU)/time_domain_signal.pdf")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("LISAEccentricFitSingleCircModel,nlive=2000,SNRcirc=20(TBU)/pure_frequency_domain_signal.pdf")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("LISAEccentricFitSingleCircModel,nlive=2000,SNRcirc=20(TBU)/frequency_domain_signal.pdf")
...
plt.tight_layout()
plt.savefig("LISAEccentricFitSingleCircModel,nlive=2000,SNRcirc=20(TBU)/snr_plot.pdf")
...
plt.grid(True, which='minor', linestyle=':', linewidth=0.5, alpha=0.4)
plt.tight_layout()
plt.savefig("LISAEccentricFitSingleCircModel,nlive=2000,SNRcirc=20(TBU)/snr_plot_data.pdf")
...
def log_likelihood_fn(A, B, C, f0, e, phi0, t, data_fft, dt,
    ...
    nAn = n_vals * (Jm21 - Jp21 - 2.0 * e * (Jm11 - Jp11))
    nBn = n_vals * (1.0 - e * e) * (Jp21 - Jm21)
    nCn = n_vals * jnp.sqrt(1.0 - e * e) * (Jp21 + Jm21 - e * (Jp11 + Jm11))
...
priors["f0"] = Uniform(0.001, 0.01, name="f0", latex_label=r"$f_{0}\ \mathrm{[Hz]}$")
priors["e"] = Uniform(0, 1, name="e", latex_label=r"$e$")
priors["phi0"] = Uniform(0, np.pi, name="phi0", latex_label=r"$\phi_{0}$")
...
if __name__ == "__main__":
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("LISAEccentricFitSingleCircModel,nlive=2000,SNRcirc=20(TBU)/frequency_domain_signal_mle.pdf")
...
# ============================================================
    ...
    ax.grid(True)
    plt.tight_layout()
    plt.savefig("LISAEccentricFitSingleCircModel,nlive=2000,SNRcirc=20(TBU)/posterior_draws_harmonics.pdf", dpi=150)