...
outdir = "LISAWeirdpriorsEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16(2)"
...
plt.grid(True)
plt.tight_layout()
plt.savefig("LISAWeirdpriorsEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16(2)/time_domain_signal.png")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("LISAWeirdpriorsEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16(2)/pure_frequency_domain_signal.png")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("LISAWeirdpriorsEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16(2)/frequency_domain_signal.png")
...
plt.tight_layout()
plt.savefig("LISAWeirdpriorsEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16(2)/snr_plot.png")
...
plt.grid(True, which='minor', linestyle=':', linewidth=0.5, alpha=0.4)
plt.tight_layout()
plt.savefig("LISAWeirdpriorsEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16(2)/snr_plot_data.png")
...
priors["e1"] = Uniform(0.35, 0.45, name="e1", latex_label=r"$e_1$")
...
if __name__ == "__main__":
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("LISAWeirdpriorsEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16(2)/frequency_domain_signal_mle.png")
...
# ============================================================
    ...
    for i, row in posterior_samples.iterrows():
        ...
        ax.scatter([2*f02_i], [circ_amp], s=8, alpha=0.3, color='tomato')
    ...
    ax.grid(True)
    plt.tight_layout()
    plt.savefig("LISAWeirdpriorsEccentricWithCircularModel,nlive=3000,0.8SNRcirc=SNRecc=16(2)/posterior_draws_harmonics.png", dpi=150)