...
outdir = "LISAQuintCircFitEccentricWithCircularModel,nlive=5000,SNRcirc=SNRecc=20(TBUP)"
...
plt.grid(True)
plt.tight_layout()
plt.savefig("LISAQuintCircFitEccentricWithCircularModel,nlive=5000,SNRcirc=SNRecc=20(TBUP)/time_domain_signal.pdf")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("LISAQuintCircFitEccentricWithCircularModel,nlive=5000,SNRcirc=SNRecc=20(TBUP)/pure_frequency_domain_signal.pdf")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("LISAQuintCircFitEccentricWithCircularModel,nlive=5000,SNRcirc=SNRecc=20(TBUP)/frequency_domain_signal.pdf")
...
plt.tight_layout()
plt.savefig("LISAQuintCircFitEccentricWithCircularModel,nlive=5000,SNRcirc=SNRecc=20(TBUP)/snr_plot.pdf")
...
plt.grid(True, which='minor', linestyle=':', linewidth=0.5, alpha=0.4)
plt.tight_layout()
plt.savefig("LISAQuintCircFitEccentricWithCircularModel,nlive=5000,SNRcirc=SNRecc=20(TBUP)/snr_plot_data.pdf")
...
if __name__ == "__main__":
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("LISAQuintCircFitEccentricWithCircularModel,nlive=5000,SNRcirc=SNRecc=20(TBUP)/frequency_domain_signal_mle.pdf")
...
# ============================================================
    ...
    for i, row in posterior_samples.iterrows():
        ...
        ax.scatter([2*f03_i], [circ_amp_3], s=8, alpha=0.3, color='orange')
        ax.scatter([2*f04_i], [circ_amp_4], s=8, alpha=0.3, color='purple')
        ax.scatter([2*f05_i], [circ_amp_5], s=8, alpha=0.3, color='green')
    ...
    ax.grid(True)
    plt.tight_layout()
    plt.savefig("LISAQuintCircFitEccentricWithCircularModel,nlive=5000,SNRcirc=SNRecc=20(TBUP)/posterior_draws_harmonics.pdf", dpi=150)