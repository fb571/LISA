...
outdir = "LISASinglePeakToBeCombined"
...
plt.grid(True)
plt.tight_layout()
plt.savefig("LISASinglePeakToBeCombined/time_domain_signal.pdf")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("LISASinglePeakToBeCombined/pure_frequency_domain_signal.pdf")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("LISASinglePeakToBeCombined/frequency_domain_signal.pdf")
...
plt.tight_layout()
plt.savefig("LISASinglePeakToBeCombined/snr_plot.pdf")
...
plt.grid(True, which='minor', linestyle=':', linewidth=0.5, alpha=0.4)
plt.tight_layout()
plt.savefig("LISASinglePeakToBeCombined/snr_plot_data.pdf")
...
priors["f0"] = Uniform(0.0015, 0.01, name="f0", latex_label=r"$f_{0}\ \mathrm{[Hz]}$")
...
if __name__ == "__main__":
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("LISASinglePeakToBeCombined/frequency_domain_signal_mle.pdf")
...
# ============================================================
    ...
    ax.grid(True)
    plt.tight_layout()
    plt.savefig("LISASinglePeakToBeCombined/posterior_draws_harmonics.pdf", dpi=150)